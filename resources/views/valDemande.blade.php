                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            @if(Auth::user()->isUser())
                                <li class="nav-item">
                                    <a href="/verifiedInfos" style="color: blue" class="nav-link">
                            ...
                            @elseif(Auth::user()->isAdminU())
                                <li class="nav-item">
                                    <a href="/valDemande" class="nav-link active">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                  <div class="container-fluid">
                    <div class="row mb-2">
                      <div class="col-sm-6">
                        <h1>Liste des demandes envoyées</h1>
                      </div>
                      <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                          <li class="breadcrumb-item"><a href="#">Accueil</a></li>
                          <li class="breadcrumb-item active">Liste des demandes envoyées</li>
                        </ol>
                      </div>
                    </div>
                  </div><!-- /.container-fluid -->
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <h3 class="card-title text-center">Liste des demandes envoyées</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                                ...
                                <tbody>
                                    ...
                                    @foreach($infos as $i)
                                        ...
                                        @endphp
                                            <td>{{ $e }}</td>
                                            <td>{{ $i->matricule }}</td>
                                            <td>Demande En traitement</td>
                                            <td>{{ $i->dateD}}</td>
                                            <td>
                                                <a class="btn btn-success" href="">Valider</a>
                                                <a class="btn btn-danger" href="">Rejeter</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
