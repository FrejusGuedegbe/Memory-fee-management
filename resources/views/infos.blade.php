                    ...
                    <div class="row mb-2">
                      ...
                      <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                          ...
                          <li class="breadcrumb-item active">Mettre à jour ses informations</li>
                        </ol>
                      </div>
                    </div>
                  </div><!-- /.container-fluid -->
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                          <div class="card-header">
                            <h3 class="card-title text-center">Mettre à jour ses informations</h3>
                          </div>
                          <!-- /.card-header -->
                          <!-- form start -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $infos->intituléEtat }}" class="form-control"  name="intituléEtat" id="exampleInputEmail1" placeholder="Entrez matricule">
                                        </div>
                                    </div>
